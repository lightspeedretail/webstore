...
//			
  ...
  KEY `idxExpires` (`uxtExpires`)
			...
			$this->add_config_key('EMAIL_SMTP_SECURITY_MODE' , "INSERT INTO `xlsws_configuration` VALUES (NULL, 'Security mode for outbound SMTP.',  'EMAIL_SMTP_SECURITY_MODE',  '0',  '0=Use Port Detection, 1=Force Open, 2=Force SSL, 3=Force TLS.',  '0',  '0', NOW( ) , NOW( ), '');" , '2.1.2');
