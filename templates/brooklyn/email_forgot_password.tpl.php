...
/**
 * template Template used as HTML email for forgotten password
 *
 *
 *
 */
...
<p><?php printf(
	_sp(
		"Your password was requested from from this Host/IP address: <strong>%s</strong>. You must change your password in your account settings once you have logged in with the temporary password above."
	), _xls_get_ip()
) ?></p>
