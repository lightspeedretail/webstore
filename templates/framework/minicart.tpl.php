...
/**
 * Framework template Mini-cart, shopping cart displayed while browsing 
 *
 * 
 *
 */
...
<?php else: ?>
				<div class="invoice" style="border-top: none;">
					<div style="height: 113px; width: 128px; margin: 50px auto 0 auto; padding: 45px 20px 0 12px; text-align: center; color: #000;"><?php if (_xls_get_conf('DEBUG_DISABLE_DRAGDROP','0') == '0' )  _xt("Drag Selections Here"); else  _xt("Your cart is empty"); ?></div>
				</div>
<?php endif; ?>
