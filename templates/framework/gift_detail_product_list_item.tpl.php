...
/**
 * Framework template Wish List (Gift Registry) Wish List product list
 * 
 * 
 *
 */
...
?>
		...
		<div class="gregistry_row">
			<a href="<?= $_ITEM->Prod->Link ?>"><img src="<?= $_ITEM->Prod->SmallImage ?>" class="gregistry_img" /></a>
				<p class="product"><a href="<?= $_ITEM->Prod->Link ?>"><?= _xls_truncate($_ITEM->Prod->Name, 60, "...\n", true); ?></a>
...
<!-- 				<p class="status"><?= $_FORM->PurchaseColumn_Render($_ITEM); ?></p>  -->
				<p class="delete" style="margin: 0 15px 0 0;"><a href="#" <?php $_FORM->pxyGiftItemDelete->RenderAsEvents($_ITEM->Rowid); ?>><img src="<?= templateNamed('css/images/btn_remove.png') ?>" alt="<?php _xt('Delete') ?>" /></a></p>
			</div>
		</div>	
