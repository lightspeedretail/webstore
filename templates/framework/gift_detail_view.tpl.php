...
/**
 * Framework template Wish List (Gift Registry) Wish List details list (description, expiry, shipping)
 * 
 * 
 *
 */
?>
	...
	<div class="registry rounded">
		<div class="registry_header">
			...
			<div class="right">
				<a href="#" <?php $this->pxyGREdit->RenderAsEvents(); ?> class="edit_gregistry" style="margin: 0 15px 0 0;"><img src="<?= templateNamed('css/images/btn_edit.png') ?>" alt="<?php _xt('Edit') ?>" style="margin: 3px 0 0 0;"><?php _xt('Edit') ?></a>
			</div>
		</div>
