...
/**
 * Framework template Edit Cart display
 *
 * 
 *
 */
...
?>
	...
	<p>
		...
		<?php if($this->btn_sendCart) $this->btn_sendCart->Render('CssClass=button padding rounded'); ?>
		<?php $this->btn_clearCart->Render('CssClass=button rounded'); ?>
	</p>
	<div class="receipt_subtotals">
	<?php if(isset($this->misc_components['order_subtotal'])  &&  ($this->misc_components['order_subtotal'] instanceOf QControl)  && $this->misc_components['order_subtotal']->Display): ?>
