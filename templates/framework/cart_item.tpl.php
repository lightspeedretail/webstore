...
/**
 * Framework template Line Item for product listed in shopping cart (Edit Cart)
 *
 * 
 *
 */
...
?>		
		  ...
		  <div class="cart_row">
			...
			<div class="receipt_row">
				<p class="price"><?= _xls_currency($_ITEM->Sell) ?><?= ($_ITEM->Discounted)?sprintf("<br/><strike>%s</strike>" , _xls_currency($_ITEM->SellBase) ):"";  ?></p>
