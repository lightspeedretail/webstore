...
/**
 * Deluxe template: Mini-cart, shopping cart displayed while browsing 
 *
 * 
 *
 */
...
<?php if($cart->Count > 0):  ?>
		...
		<?php  if(!$item->Prod) continue; ?>
				...
				<div class="minicart_item" style="border-top: none;">
					...
					<img src="<?= $item->Prod->MiniImage ?>" height="<?php echo _xls_get_conf('MINI_IMAGE_HEIGHT'); ?>px" width="<?php echo _xls_get_conf('MINI_IMAGE_WIDTH'); ?>px"/>    			
