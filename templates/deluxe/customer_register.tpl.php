...
<div style="clear: both;"></div>
    ...
    <legend><?php _xt("Account Information") ?></legend>
		...
		<div class="left margin">
        	...
        	<dl>
            <dd>
               <br/> <?php $this->chkHtmlEmail->Render() ?><label for="htmlemail" class="opt"><?php _xt("Receive HTML Email (Uncheck this box if you want to receive Text-Only email)") ?></label>
            </dd>
            </dl>
        	</div>
    </fieldset>
