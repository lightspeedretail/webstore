...
/**
 * Deluxe template: Login popup box (upper right Login link) 
 *
 * 
 *
 */
...
<div class="login">
			<h1>Login <a href="<? echo _xls_site_url('customer-register/pg/'); ?>" style="font-size: 14px;"><?php _xt('Create an Account') ?></a></h1>
