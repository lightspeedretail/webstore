...
/**
 * Deluxe template: Template used as HTML email to store that an order 
...
<br /><?php _xt("Hi Store owner") ?>,<br/><br/>

<?php _xt("You have a new order  ") ?>  <strong><?php echo $cart->IdStr ;   ?></strong>. <br/><br/>
