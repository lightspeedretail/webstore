...
<div class="add_gregistry"><a href="#" <?= $this->pxyGRCreate->RenderAsEvents(); ?>><img
	src="<?= templateNamed('css/images/btn_add.png') ?>" alt="<?php _xt('Add'); ?>"
	style="margin: 0 2px -3px 0;"/> <?php _xt('Create New Wish List'); ?></a></div>
