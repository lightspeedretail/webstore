...
class ModelCode extends CCodeModel {
      ...
      public function rules() {
	    return array_merge(parent::rules(), array(
			array('tablePrefix, baseClass, tableName, modelClass, modelPath, abstractModelPath', 'filter', 'filter' => 'trim'),
			array('tableName, modelPath, abstractModelPath, baseClass', 'required'),
			...
			array('tablePrefix, modelPath, abstractModelPath, baseClass, buildRelations, buildConcreteClass', 'sticky'),
		    ));
      }
      ...
      public function validateAbstractModelPath($attribute, $params) {
	    if (Yii::getPathOfAlias($this->abstractModelPath) === false)
		  $this->addError('abstractModelPath', 'Abstract Model Path must be a valid path alias.');
      }
