...
//Web Store version
require_once( dirname(__FILE__) . '/wsver.php');
...
return CMap::mergeArray(
    ...
    'modules' =>
        array_merge(require(dirname(__FILE__).'/modules.php'), //dynamically load all modules in /modules
	    array(
...
//	),
	// application components
	'components'=>
	    array_merge(require(dirname(__FILE__).'/wscomponents.php'), //dynamically load all modules in /modules
		array(
//		'request' => array(
//			'baseUrl' => '',
//		),
