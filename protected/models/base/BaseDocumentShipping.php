...
/**
 * This is the base model class for table "{{document_shipping}}".
 *
 * The followings are the available columns in table '{{document_shipping}}':
 * @property string $id
 ...
 * @name BaseDocumentShipping
 */
abstract class BaseDocumentShipping extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'documents' => array(self::HAS_MANY, 'Document', 'shipping_id'),
		);
	}
