   ...
   class xlsws_track_sro extends xlsws_index {
		...
		protected function build_main(){
            ...
            if($this->customer){
				...
				$sros = Sro::QueryArray(QQ::OrCondition(QQ::Equal(QQN::Sro()->CustomerEmailPhone , $this->customer->Email) , QQ::Equal(QQN::Sro()->CustomerEmailPhone , $this->customer->Mainphone)) , QQ::Clause(
		...
		protected function search_SRO(){
			...
			$this->sro = Sro::QuerySingle(QQ::AndCondition(QQ::Equal(QQN::Sro()->LsId , $orderid) 
