   ...
   class xlsws_track_order extends xlsws_index {
		...
		protected function build_main(){
            ...
            if($this->customer){
				...
				$orders = Cart::QueryArray(QQ::AndCondition(
							QQ::Equal(QQN::Cart()->Email , $this->customer->Email) 
							, QQ::OrCondition(QQ::Equal(QQN::Cart()->Type , CartType::order)
...
//				$zipcode = trim($this->txtZipCode->Text);
				...
				$this->order = Cart::QuerySingle(QQ::AndCondition(QQ::Equal(QQN::Cart()->IdStr , $orderid) 
				, QQ::OrCondition(
