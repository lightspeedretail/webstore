   ...
   class xlsws_contact_us extends xlsws_index {
       ...
       /**
	    ...
	    protected function Form_Validate() {
			...
			, _xls_mail_body_from_template(templateNamed('email_msg.tpl.php') , array('msg' => sprintf( " Customer Name %s <br/>\nCustomer Email %s<br/>\n Customer Phone %s<br/>\n<br/>\n%s" , $this->txtName->Text , $this->txtEmail->Text , $this->txtPhone->Text , nl2br(strip_tags($this->txtMsg->Text)) )
			))
			);
