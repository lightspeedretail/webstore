 ...
 */
   ...
   class xlsws_advanced_search extends xlsws_index {
        ...
        protected function build_main() {
			...
			$this->crumbs[] = array('key'=>'xlspg=advanced_search' , 'case'=> '' , 'name'=> _sp("Advanced Search"));
	    ...
	    protected function butSubmit_click($strFormId, $strControlId, $strParameter){
	    	...
	    	_rd("index.php?advsearch=true&search=" . urlencode($this->txtSearch->Text) . "&startprice=" . $this->txtStartPrice->Text . "&endprice=" . $this->txtEndPrice->Text . "&filter=" . $this->lstFilters->SelectedValue . "&c=".$cat);
