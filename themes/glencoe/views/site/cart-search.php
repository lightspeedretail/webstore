        ...
        <div class="col-xs-12 col-sm-12">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="btn-group" id="shoppingcart">
                            <button class="btncart" data-toggle="dropdown">
                                <img src="/themes/glencoe/css/images/carticon.png" alt="cart icon">CART  <span class="lightgrey"><?= Yii::app()->shoppingcart->totalItemCount ?>  &nbsp;item(s)</span>  <span class="caret"></span>
                            </button>
				                        ...
				                        <?php if (count(Yii::app()->shoppingcart->cartItems)==0)
					                        ...
					                        <table>
						                        ...
						                        <tr>
							                        ...
							                        <td class="cartdropdown" id="cartsubtotal-dropdown">
