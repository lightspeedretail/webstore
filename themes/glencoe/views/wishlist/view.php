...
<div id="wishlistdisplay" class="col-sm-12">
    ...
    <div id="wishlistHeader" class="col-sm-5">
    ...
    <div class="row rowborder midrow hidden2-mobile">
        <div class="col-sm-5"><span class="cartlabel heading light"><?= Yii::t('global','Products') ?></span></div>
        <div class="col-sm-2 cart_price"><span class="cartlabel heading light"><?= Yii::t('global','Qty') ?></span></div>
        <div class="col-sm-3"><span class="cartlabel heading light"><?= Yii::t('global','Status') ?></span></div>
        <div class="col-sm-2 centeritem"><span class="cartlabel heading light"><?= Yii::t('global','Edit') ?></span></div>
    </div>

	<?php foreach ($model->wishlistItems as $item): ?>
		<?php if ($item->product != null): ?>
		    <div class="row rowborder midrow">
		        <div class="col-sm-2 list_item">
				<span class="list_image">
					<a href="<?= $item->product->Link; ?>">
		                <img src="<?= $item->product->SmallImage ?>" alt="<?= _xls_truncate($item->product->Title, 65, "...\n", true); ?>" />
		            </a>
				</span>
		        </div>
		        <div class="col-sm-3">
		        ...
		        <div class="col-sm-2">
			        <span id="qty-<?= $item->id ?>" class="cart_qty">
				        <?php echo Yii::t('wishlist','Qty').': '.$item->qty; ?>
			        </span>
