...
<div class="row contain_buttons">

    <div class="col-sm-2 cart_icons btns">
    ...
    <div class="col-sm-3 cart_icons btns">
		<?php echo CHtml::ajaxButton(
	...
	<div class="col-sm-4 checkoutlink btns">
	<?php echo CHtml::htmlButton(Yii::t('cart','Checkout'),
		array(
