		...
		<div class="row-fluid">
			<fieldset class="span10">
				<div id="CustomerContactShippingAddress">
					...
					<div class="row-fluid">
						<div id="shippingFirstName" class="span6">
						...
						<div id="shippingLastName" class="span6">
					...
					<div class="row-fluid">
						<div id="shippingAddress1" class="span12">
						...
						<div id="shippingAddress2" class="span12">
		...
		<div id="CustomerContactBillingAddress">
			<fieldset class="span10">
				...
				<div id="CustomerContactBillingAddressAdd">
					...
					<div class="row-fluid">
						<div id="billingAddress1" class="span12">
						...
						<div id="billingAddress2" class="span12">
...
<?php //The contents of the div id=cartItems are refreshed through various AJAX actions such as taxes and shipping ?>
	...
	<div id="submitblock">
		<div class="row-fluid">
			...
			<?php echo CHtml::submitButton('Submit',array('id'=>'checkoutSubmitButton','class'=>'btn-block')); ?>
		</div>
	</div>
