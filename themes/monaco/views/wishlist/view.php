...
<div id="wishlistdisplay" class="span12">
	<div class="row">
		<div id="wishlist-title" class="span6">
	...
	<div class="row">
		<div class="span4 event_date">
			<?php if($model->event_date) echo Yii::t('global','Event Date').": ".$model->event_date; ?>
		</div>
	</div>
    ...
    <div id="wishlistitems">
	    <div class="row-fluid rowborder midrow">
		    ...
		    <div class="span4">&nbsp;</div>
		    <div class="span3 cart_price"><span class="cartlabel heading light"><?= Yii::t('global','Qty') ?></span></div>
				...
				<span class="list_image">
				    ...
				    <div class="span1 centeritem">
					    <?php echo CHtml::ajaxLink(Yii::t('global','Edit'),array('wishlist/edititem'),
						    ...
						    ), array('id'=>'editItem'.$item->id, 'class'=>'editwish1'));
					    ?>
				    </div>
			    </div>
		    <?php endif; ?>
