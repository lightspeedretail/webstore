...
?>
	...
	<div class="row-fluid">
		<label><?php echo Yii::t('wishlist', 'Allow buyers to ship my wish list items directly to me at') . ':'; ?></label>
		<?php echo $form->dropDownList($model,'ship_option', $model->getShippingOptions()); ?>
		<?php echo $form->error($model,'ship_option'); ?>
	</div>
	<div class="row-fluid spaceafter">
		<label><?php echo Yii::t('wishlist', 'As wish list items are purchased') . ':' ?></label>
