...
class Destination extends BaseDestination
{
	...
	/**
	 * Get the TaxCode for the default shipping destination
	 * 
	 * @return integer taxmode
	 */
	public static function getDefaultDestinationTaxCode()
	{
		$defaultDestination = Destination::model()->findByAttributes(array('country' => null,'state' => null));
		return $defaultDestination->taxcode;
	}

	/**
	 * Get the 'catch-all' shipping/tax destination, (ANY/ANY).
	 *
	 *
	 * @return Destination
	 */
	public static function getAnyAny()
	{
