...
abstract class BaseWishlist extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('registry_name, after_purchase, customer_id, gift_code', 'required'),
			...
			array('id, registry_name, registry_description, visibility, event_date, ship_option, after_purchase, customer_id, gift_code, created, modified', 'safe', 'on'=>'search'),
		);
	}
