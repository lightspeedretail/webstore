...
// Extends BaseCheckoutForm to handle different validation scenarios
...
class MultiCheckoutForm extends CheckoutForm
{
	...
	public function rules()
	{
		return array(
			...
			array(
				...
				pickupPerson, pickupPersonEmail, pickupPersonPhone,
				intShippingAddress, intBillingAddress, billingSameAsShipping,
				shippingFirstName, shippingLastName,
				shippingAddress1, shippingAddress2, shippingCity, shippingState, shippingPostal, shippingCountry,
	...
	public static function saveToSession($checkoutForm)
	{
		...
		Yii::log(print_r($checkoutForm->attributes, true), 'error', 'application.'.__CLASS__.".".__FUNCTION__);
	}
