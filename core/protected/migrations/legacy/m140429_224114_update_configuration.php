...
{
  public function find($table, $clause, $params)
  {
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'VIEWSET')))
    {
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'LANG_MENU')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'AUTO_UPDATE')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'AUTO_UPDATE_TRACK')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', 
      array(':key' => 'LIGHTSPEED_HOSTING_COMMON_SSL')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', 
      array(':key' => 'LIGHTSPEED_HOSTING_LIGHTSPEED_URL')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', 
      array(':key' => 'LIGHTSPEED_HOSTING_CUSTOM_URL')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'IMAGE_ZOOM')))
    {
		$this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', 
      array(':key' => 'LIGHTSPEED_HOSTING_SHARED_TIME')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'GOOGLE_FONTS_LINK')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SOCIAL_FACEBOOK')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SOCIAL_TWITTER')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SOCIAL_LINKEDIN')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SOCIAL_PINTEREST')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SOCIAL_INSTAGRAM')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'SHOW_FAMILY')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'LIGHTSPEED_CLOUD')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'LIGHTSPEED_MT')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'LIGHTSPEED_UPDATER')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', 
      array(':key' => 'LIGHTSPEED_SHOW_RELEASENOTES')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('configuration', 'key_name=:key', array(':key' => 'LIGHTSPEED_CID')))
    {
      $this->insert('xlsws_configuration',array(
    ...
    if(!$this->find('modules', 'module=:key', array(':key' => 'wsamazon')))
    {
