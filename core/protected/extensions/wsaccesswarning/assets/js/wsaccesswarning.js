...
function injectAccessWarningDiv() {
	var htmlString = '<div class="webstore-modal webstore-modal-login webstore-modal-narrow" id="verification">'
		+ '<section id="webstore-verification">'
		+ '<main class="verification">'
		+ '<p>' + accessWarningMessage + '</p>'
		+ '</main>'
		+ '<footer class="submit">'
		+ '<input type="submit" value="' + accessWarningButtonCaption + '">'
		+ '</footer>'
		+ '</section>'
		+ '</div>';
