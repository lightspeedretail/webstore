								...
								<table>
									<tbody>
										<tr id="PromoCodeLine" class="<?php echo Yii::app()->shoppingcart->promoCode ? 'webstore-promo-line' : 'webstore-promo-line hide-me';?>" >
											<th colspan='2'>
												<?php echo Yii::t('cart','Promo & Discounts')." <td id=\"PromoCodeStr\"  class=\"money promo-code-str\">" . Yii::app()->shoppingcart->totalDiscountFormatted; ?></td>
											</th>
										</tr>
										<tr class="subtotal">
									...
									<tr class="total">
										...
										<td id="CartTotal" class="wsshippingestimator-total-estimate total-estimate money"><?php echo _xls_currency(Yii::app()->shoppingcart->total); ?></td>
									</tr>
									</tfoot>
								</table>
							</div>
