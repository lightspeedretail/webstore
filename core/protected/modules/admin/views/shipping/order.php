<div class="span9">
    ...
    <div class="hero-unit">
        <div class="editinstructions">
		   <p><?php echo Yii::t('admin','This is the display order for Shipping modules on checkout. The topmost module will be the default. (Note that any restrictions may mean not all options are available on every checkout.)'); ?></p>
	...
	<input type="hidden" id="controller" value="shipping">
	<ul id="sortable">
