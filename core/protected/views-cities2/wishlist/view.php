...
<div id="wishlistdisplay" class="col-sm-12">
    ...
    <div class="row rowborder midrow">
        <div class="col-xs-5"><span class="cartlabel heading light"><?= Yii::t('global','Products') ?></span></div>
        <div class="col-xs-2 cart_price"><span class="cartlabel heading light"><?= Yii::t('global','Qty') ?></span></div>
        <div class="col-xs-3"><span class="cartlabel heading light"><?= Yii::t('global','Status') ?></span></div>
        <div class="col-xs-2 centeritem"><span class="cartlabel heading light"><?= Yii::t('global','Edit') ?></span></div>
    </div>
		    ...
		    <div class="row rowborder midrow">
				...
				<span class="list_image">
					<a href="<?= $item->product->Link; ?>">
		                <img src="<?= $item->product->MiniImage ?>" alt="<?= _xls_truncate($item->product->Title, 65, "...\n", true); ?>" />
		            </a>
				</span>
		        </div>
		        <div class="col-sm-3">
