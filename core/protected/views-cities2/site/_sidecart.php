<div id="shoppingcart">
		...
		<?php if(!empty(Yii::app()->shoppingcart)):
			foreach (Yii::app()->shoppingcart->cartItems as $item): ?>
				...
				<div id="cartline<?=$item->id?>" class="minicart_item">
						...
						<span class="col-sm-6 minicart_desc">
						...
						<span class="col-sm-3 minicart_price">
	...
	<div id="shoppingcartbottom">
		<div class="cart_label col-sm-7"><span class="subtotallabel"><?php echo Yii::t('cart','SubTotal'); ?></span></div>
		<div class="cart_price col-sm-5"><span id="subtotal"><?= _xls_currency(Yii::app()->shoppingcart->subtotal) ?></span>&nbsp;&nbsp;</div>
	</div>
