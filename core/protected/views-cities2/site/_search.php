...
//					}',
//			))); ?>
        <input type="search" name="q" id="xlsSearch" placeholder="<?= Yii::t('global','SEARCH').'...' ?>">
	</span>
	...
	<span class="search_advanced right"><a href="<?php echo _xls_site_url('/search'); ?>"><img class="spyglass" src="<?= Yii::app()->theme->baseUrl; ?>/css/images/spyglass.png"></a></span>
