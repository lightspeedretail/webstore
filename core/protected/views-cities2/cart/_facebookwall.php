...
<div class="row">
	...
	<div class="col-sm-10 clearfix facebook_wall">
		<div class="row">
			<div class="col-sm-2"><?php echo CHtml::image(Yii::app()->baseUrl."/images/facebook.png","Facebook"); ?></div>
			<div class="col-sm-10"><h4><?= Yii::t('facebook',_xls_get_conf('FACEBOOK_WALL_PUBLISH')) ?></h4>
		...
		<div class="row">
			<div id="submitSpinner" class="col-sm-3" style="display:none">
