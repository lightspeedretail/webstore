<div class="span9">
	...
	<span class="search_left">
		<img class="spyglass" src="<?= Yii::app()->theme->baseUrl; ?>/css/images/spyglass.png">
	</span>
...
<div class="span1">
	<span class="search_advanced right">
		<a href="<?= $this->createUrl('/search'); ?>"><img class="spyglass" src="<?= Yii::app()->theme->baseUrl; ?>/css/images/adv_search.png"></a>
	</span>
</div>
