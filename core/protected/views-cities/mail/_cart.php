	...
	<table>
	    <tr>
	        <th class="graphicheader">
		        <?php echo CHtml::link(CHtml::image($this->pageAbsoluteHeaderImage)); ?>
	        </th>
	    </tr>
	</table>
	<table>
	    <tbody>
	        <td style="padding:15px;" width="750px">
				...
				<?php echo Yii::t('email',"Dear") ?>  <?= $model->toName ?>,<br/><br/>

				<?php echo Yii::t('email',"{name} has sent you the following message from {storename}",
